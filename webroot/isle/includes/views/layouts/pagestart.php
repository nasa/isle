...
<body>
	...
	<span class="logout floatRight">
          Welcome, <?php echo $u['name']; ?>
          &nbsp;&nbsp;<a id="logout" href="javascript:void(0);">Sign Out</a>
          <br />
          <a href="<?php echo $rootdir; ?>assets?item=user&value=<?php echo $u['uid']; ?>">My Assets</a>
        </span>
	...
	<div id="nav">
	  <ul>
	    ...
	    <?php if($u['role'] >= ISLE\Models\Role::CONTRIBUTOR) { ?><li>
	      <a href="<?php echo $rootdir; ?>attributes">Attributes</a>
            </li>
            <li>
	      <a href="<?php echo $rootdir; ?>relations">Relations</a>
            </li>
	    <?php }//endif ?><?php if($u['role'] >= ISLE\Models\Role::ADMIN) { ?><li><a href="<?php echo $rootdir; ?>users">Users</a></li>
	    <li>
              <a href="<?php echo $rootdir; ?>logs">Logs</a>
	    </li><?php } ?>
	  </ul>
    ...
    <div id="middle">
	  ...
	  <div id="userMessage" role="alert" aria-label="<?php echo htmlspecialchars($_SESSION['message']['text']); ?>" class="fade in alert<?php echo ' ' . $_SESSION['message']['type']; ?>">
	    <a class="close" href="#" role="button" aria-label="Close" data-dismiss="alert">&times;
