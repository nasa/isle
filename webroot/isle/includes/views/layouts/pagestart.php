...
<body>
    ...
    <div id="top">
      <div id="header">
        <span class="logout floatRight">Welcome, <?php echo $u['name']; ?> &nbsp;&nbsp;<a id="logout" href="javascript:void(0);">Sign Out</a><br /><a href="<?php echo $rootdir; ?>assets?item=user&value=<?php echo $u['uid']; ?>">My Assets</a></span>
		  <!--tabindex on anchor tags is needed for submenus to function in safari and chrome.-->
        <h1>ISLE: <?php echo $svc->getInstanceName(); ?></h1><?php if (!isset($hidenav) or !$hidenav) { ?><div id="nav"><ul><li><a href="<?php echo $rootdir; 
