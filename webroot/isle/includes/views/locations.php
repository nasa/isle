...
<div class="listLeft center">
  ...
  <button type="button" name="addItemBtn" value="add" id="addItemBtn" class="btn btn-primary" autofocus="autofocus"><i class="icon-plus icon-white"></i> Add Location</button>
  <?php } ?>
</div>
