<?php
    ...
    $fieldNames['id'] = "hidId";
    $fieldNames['unit'] = "txtUnit";
    $fieldNames['abbr'] = "txtAbbr";
    $fieldNames['parent'] = "txtParent";
    
    $tmpl_headcontent = "<title>ISLE: " . ISLE\Service::getInstanceName() . " - Attribute Types</title>";
    ...
    require_once $viewsPath . 'attributetypes.php';
