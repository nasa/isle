...
(function($) {
    ...
    $.widget('ui.tagit', {
            ...
            if (this.options.tagSource) {
                this._tagInput.autocomplete({
                    ...
                    select: function(event, ui) {
                        ...
                        var tag = that.createTag(ui.item.value, ui.item.label);
        ...
        tagLabel: function(tag) {
            ...
            if (this.options.singleField) {
                return $(tag).children('.tagit-label').attr('data-value');
            } else {
        ...
        createTag: function(value, tagLabel, additionalClass) {
            ...
            if (tagLabel) {
                var label = $(this.options.onTagClicked ? '<a class="tagit-label" data-value="' + value + '"></a>' : '<span class="tagit-label" data-value="' + value + '"></span>').text(tagLabel);
            }
            else {
                var label = $(this.options.onTagClicked ? '<a class="tagit-label" data-value="' + value + '"></a>' : '<span class="tagit-label" data-value="' + value + '"></span>').text(value);
            }
