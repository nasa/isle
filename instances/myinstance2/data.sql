INSERT INTO `myinstance2_locations` (`id`, `center`, `bldg`, `room`) VALUES
(1, 'CENTER', '111', '100');

INSERT INTO `myinstance2_manufacturers` (`id`, `name`, `url`, `parent`) VALUES
(1, 'Dell', 'http://www.dell.com', NULL);

INSERT INTO `myinstance2_asset_models` (`id`, `mfr`, `model`, `desc`, `series`, `url`, `img`) VALUES
(1, 1, '350', 'Dell Precision 350 Desktop Computer', 'Precision', NULL, NULL);

INSERT INTO `myinstance2_assets` (`id`, `model`, `location`, `serial`, `notes`) VALUES
(1, 1, 1, 'G709641', NULL);
...
INSERT INTO `myinstance2_attribute_types` (`id`, `unit`, `abbr`, `parent`) VALUES
(5, 'meter', 'm', 3),
(6, 'kilogram', 'kg', 3),
(7, 'second', 's', 3),
(8, 'ampere', 'A', 3),
...
INSERT INTO `myinstance2_attributes` (`id`, `name`, `type`) VALUES
(1, 'Width', 5),
(2, 'Length', 5),
(3, 'Height', 5),
(4, 'Mass', 6),
...
INSERT INTO `myinstance2_categories` (`id`, `name`, `parent`) VALUES
(1, 'Computers', NULL),
...
INSERT INTO `myinstance2_asset_model_categories` (`id`, `model`, `category`) VALUES
(1, 1, 3);

-- config-todo: add admin account
INSERT INTO `myinstance2_users` (`id`, `uid`, `name`, `email`, `role`) VALUES
(1, 1, 'admin', 'SPG-DevOps@cavium.com', 16);
